...
REQUIRED = [
    ...
    "schemas/delegation-request.yaml", "schemas/delegation-request.example.yaml", "schemas/delegation-preflight.yaml", "schemas/resolved-execution-plan.yaml", "schemas/agent-status.yaml", "schemas/context-packet-benchmark.yaml", "schemas/goal-lifecycle.yaml",
    "runtime/__init__.py", "runtime/contracts.py", "runtime/preflight.py", "runtime/registry.py", "runtime/context_packet.py", "runtime/lifecycle.py", "policies/agent-lifecycle.md",
    "eas_cli/__init__.py", "eas_cli/__main__.py", "eas_cli/version.py", "eas_cli/paths.py", "eas_cli/health.py", "eas_cli/operations.py", "eas_cli/goals.py", "eas_cli/cli.py",
    ...
    "tests/test_runtime_first.py", "tests/test_cli_distribution.py", "tests/test_identity_attribution.py",
